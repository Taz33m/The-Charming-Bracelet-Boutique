...
const bracelets = [
  ...
  { id: 8, name: 'Cosmic Butterfly', price: 8, image: '/bracelets/bracelet_8.jpg', rating: 4.6 },
  { id: 9, name: 'Starry Dreams', price: 8, image: '/bracelets/bracelet_9.jpg', rating: 4.7 },
  { id: 10, name: 'Strawberry Bliss', price: 8, image: '/bracelets/bracelet_10.jpg', rating: 4.3 },
  { id: 11, name: 'Mystic Meadow', price: 8, image: '/bracelets/bracelet_11.jpg', rating: 4.5 },
  { id: 12, name: 'Tropical Escape', price: 8, image: '/bracelets/bracelet_12.jpg', rating: 4.6 },
  { id: 13, name: 'Stellar Dreams', price: 8, image: '/bracelets/bracelet_13.jpg', rating: 4.7 },
  { id: 14, name: 'Wings of Wonder', price: 8, image: '/bracelets/bracelet_14.jpg', rating: 4.8 },
  { id: 15, name: 'Ocean Charm', price: 8, image: '/bracelets/bracelet_15.jpg', rating: 4.9 },
  { id: 16, name: 'Heart & Sea', price: 8, image: '/bracelets/bracelet_16.jpg', rating: 4.4 },
  { id: 17, name: 'Joyful Cloud', price: 8, image: '/bracelets/bracelet_17.jpg', rating: 4.7 },
  { id: 18, name: 'Natures Treasure', price: 8, image: '/bracelets/bracelet_18.jpg', rating: 4.5 },
  { id: 19, name: 'Royal Butterfly', price: 8, image: '/bracelets/bracelet_19.jpg', rating: 4.9 },
  { id: 20, name: 'Sweet Strawberry', price: 8, image: '/bracelets/bracelet_20.jpg', rating: 4.8 },
  { id: 21, name: 'Island Treasure', price: 8, image: '/bracelets/bracelet_21.jpg', rating: 4.7 },
  { id: 22, name: 'Bunny Bliss', price: 8, image: '/bracelets/bracelet_22.jpg', rating: 4.6 },
  { id: 23, name: 'Seahorse Love', price: 8, image: '/bracelets/bracelet_23.jpg', rating: 4.9 },
  { id: 24, name: 'Moonlit Swan', price: 8, image: '/bracelets/bracelet_24.jpg', rating: 4.7 },
  { id: 25, name: 'Musical Heart', price: 8, image: '/bracelets/bracelet_25.jpg', rating: 4.6 },
  { id: 26, name: 'Crimson Waves', price: 6, image: '/bracelets/bracelet_26.jpg', rating: 4.5 },
  { id: 27, name: 'Pastel Heart', price: 6, image: '/bracelets/bracelet_27.jpg', rating: 4.7 },
  { id: 28, name: 'Ruby Tide', price: 6, image: '/bracelets/bracelet_28.jpg', rating: 4.4 },
  { id: 29, name: 'Scarlet Harmony', price: 6, image: '/bracelets/bracelet_29.jpg', rating: 4.6 },
  { id: 30, name: 'Winter Charm', price: 6, image: '/bracelets/bracelet_30.jpg', rating: 4.8 },
  { id: 31, name: 'Ocean Breeze', price: 6, image: '/bracelets/bracelet_31.jpg', rating: 4.6 },
  { id: 32, name: 'Frozen Dream', price: 6, image: '/bracelets/bracelet_32.jpg', rating: 4.7 },
  { id: 33, name: 'Flaming Sunset', price: 6, image: '/bracelets/bracelet_33.jpg', rating: 4.8 },
  { id: 34, name: 'Ruby Delight', price: 6, image: '/bracelets/bracelet_34.jpg', rating: 4.9 },
  { id: 35, name: 'Seafoam Star', price: 6, image: '/bracelets/bracelet_35.jpg', rating: 4.5 },
  { id: 36, name: 'Candy Swirl', price: 6, image: '/bracelets/bracelet_36.jpg', rating: 4.6 },
  { id: 37, name: 'Toyland Charm', price: 6, image: '/bracelets/bracelet_37.jpg', rating: 4.7 },
  { id: 38, name: 'Lollipop Dream', price: 6, image: '/bracelets/bracelet_38.jpg', rating: 4.8 },
  { id: 39, name: 'Nighttime Play', price: 6, image: '/bracelets/bracelet_39.jpg', rating: 4.5 },
  { id: 40, name: 'Moonlight Melody', price: 6, image: '/bracelets/bracelet_40.jpg', rating: 4.6 },
  { id: 41, name: 'Red Rider', price: 6, image: '/bracelets/bracelet_41.jpg', rating: 4.7 },
  { id: 42, name: 'Starlight Carousel', price: 6, image: '/bracelets/bracelet_42.jpg', rating: 4.8 }
]
...
export default function Component() {
  ...
  const [selectedBracelet, setSelectedBracelet] = useState<typeof bracelets[0] | null>(null);
  ...
  const QuickViewModal = ({ bracelet, onClose }: { bracelet: typeof bracelets[0], onClose: () => void }) => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Button onClick={() => addToCart(bracelet)} className="w-full bg-[#81D8D0] hover:bg-[#6BC2BA] text-white">
            Add to Cart
          </Button>
        </motion.div>
      </motion.div>
      ...
      <div className="container mx-auto px-4 py-6 flex justify-between items-center">
        ...
        <nav className="hidden md:block">
          <ul className="flex space-x-6">
            ...
            <li>
              <button onClick={() => setIsCartOpen(true)} className="hover:text-gray-200 transition-colors relative">
  ...
  >
          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                <Button onClick={() => openQuickView(bracelet)} className="bg-white text-[#81D8D0] hover:bg-gray-100">
                  Quick View
                </Button>
              </div>
            </div>
    ...
    <AnimatePresence>
      {selectedBracelet && (
        <QuickViewModal bracelet={selectedBracelet} onClose={() => setSelectedBracelet(null)} />
      )}
    </AnimatePresence>
  </motion.div>
)
  ...
  const openQuickView = (bracelet: typeof bracelets[0]) => {
