...
// Debugging: Log the bracelet images to check if they're correctly referenced
console.log('Bracelet Images:', bracelets.map(b => b.image));

// Debugging: Add error handling for image loading
