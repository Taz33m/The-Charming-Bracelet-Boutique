...
const bracelets = [
  { id: 1, name: 'Elegant Pearl Charm', price: 129.99, image: '/placeholder.svg?height=300&width=300', rating: 4.5 },
  { id: 2, name: 'Sapphire Dream', price: 199.99, image: '/placeholder.svg?height=300&width=300', rating: 4.8 },
  { id: 3, name: 'Golden Infinity', price: 149.99, image: '/placeholder.svg?height=300&width=300', rating: 4.2 },
  { id: 4, name: 'Silver Starlight', price: 89.99, image: '/placeholder.svg?height=300&width=300', rating: 4.6 },
  { id: 5, name: 'Rose Gold Harmony', price: 179.99, image: '/placeholder.svg?height=300&width=300', rating: 4.7 },
  { id: 6, name: 'Emerald Enchantment', price: 219.99, image: '/placeholder.svg?height=300&width=300', rating: 4.9 },
]
          ...
          {bracelets.map((bracelet, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Button className="w-full bg-[#81D8D0] hover:bg-[#6BC2BA] text-white">Add to Cart</Button>
              </div>
            </motion.div>
          ))}
        </div>
